...
wait-for-it --service localhost:8888 --timeout 45
...
wait-for-it --service localhost:8761 --timeout 45
...
wait-for-it --service localhost:8081 --service localhost:8082 --service localhost:8083 --timeout 120 --parallel
...
wait-for-it --service localhost:8080 --timeout 45
...
wait-for-it --service localhost:9090 --timeout 45
